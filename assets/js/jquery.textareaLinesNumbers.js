    ...
    $.textareaLinesNumbers = function(element, options) {
        ...
        this.init = function() {
            ...
            if (this.$main.find('.linesContainer').length <= 0) {
                this.$main.prepend('<textarea class="linesContainer" tabindex="-1"></textareay>');
            }
        ...
        this.bindEvents = function() {
            ...
            if (typeof events != 'boolean' || events !== true) {
                ...
                this.$textarea.on({
                    'input.textareaLinesNumbers': $.proxy(function() {
                        this.setLine();
                    }, this),
                    'scroll.textareaLinesNumbers': $.proxy(function() {
                        this.setLine();
                    }, this),
                    'blur.textareaLinesNumbers': $.proxy(function() {
                        this.setLine();
                    }, this),
                    'focus.textareaLinesNumbers': $.proxy(function() {
                        this.setLine();
                    }, this),
                    'resize.textareaLinesNumbers': $.proxy(function() {
                        this.updateSize();
                        this.setLine();
                    }, this)
                });
